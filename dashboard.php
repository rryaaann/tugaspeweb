...
.edit-button {
  background-color: var(--action-color); /* Warna hijau */
  border: none;
  color: white;
  padding: 8px 16px;
  text-align: center;
...
.edit-button:hover {
  background-color: #45a049; /* Warna hijau saat dihover */
}
...
.delete-button:hover {
  background-color: #d32f2f; /* Warna merah saat dihover */
}
...
<div class="app-container">
  <div class="sidebar">
    ...
    <div class="account-info">
      <div class="account-info-picture">
        <img src="https://www.pngmart.com/files/11/Trollface-Meme-PNG-Picture.png" alt="Account">
      </div>
      <div class="account-info-name">ryan/221240001281</div>
  ...
  <div class="app-content">
    <div class="app-content-header">
      ...
      <a href="tambah_produk.php" class="app-content-headerButton">Add Product</a>
    ...
    <div class="products-area-wrapper tableView">
      <div class="products-header">
        ...
        <div class="product-cell category">SKU/ID<button class="sort-button">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512">
              <path fill="currentColor" d="M496.1 138.3L375.7 17.9c-7.9-7.9-20.6-7.9-28.5 0L226.9 138.3c-7.9 7.9-7.9 20.6 0 28.5 7.9 7.9 20.6 7.9 28.5 0l85.7-85.7v352.8c0 11.3 9.1 20.4 20.4 20.4 11.3 0 20.4-9.1 20.4-20.4V81.1l85.7 85.7c7.9 7.9 20.6 7.9 28.5 0 7.9-7.8 7.9-20.6 0-28.5zM287.1 347.2c-7.9-7.9-20.6-7.9-28.5 0l-85.7 85.7V80.1c0-11.3-9.1-20.4-20.4-20.4-11.3 0-20.4 9.1-20.4 20.4v352.8l-85.7-85.7c-7.9-7.9-20.6-7.9-28.5 0-7.9 7.9-7.9 20.6 0 28.5l120.4 120.4c7.9 7.9 20.6 7.9 28.5 0l120.4-120.4c7.8-7.9 7.8-20.7-.1-28.5z" />
            </svg>
          </button></div>
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<div class="product-cell image">
                  <img src="' . $row['gambar_produk'] . '" alt="product">
                  <span>' . $row['nama_produk'] . '</span>
                </div>';
        echo '<div class="product-cell category"><span class="cell-label">Category:</span>' . $row['id_produk'] . '</div>';
        echo '<div class="product-cell status-cell">
                  <span class="cell-label">Status:</span>
                  <span class="status active">Active</span>
                </div>';
        echo '<div class="product-cell stock"><span class="cell-label">Stock:</span>' . $row['stok'] . '</div>';
        echo '<div class="product-cell price"><span class="cell-label">Price:</span>' . $row['harga'] . '</div>';

        // Tombol Edit dan Delete
        echo '<a href="edit.php?id=' . $row['id_produk'] . '"><button class="edit-button">Edit</button></a>';
        echo '<a href="delete.php?id=' . $row['id_produk'] . '"><button class="delete-button">Delete</button></a>';
        echo '<a href="transaksi.php?id=' . $row['id_produk'] . '"><button class="delete-button">Beli</button></a>';
...
<script>
        ...
        window.onload = function() {
            setTimeout(function(){
                alert('berhasil!');
            }, 3000); // Tampilkan pop-up selama 3 detik setelah halaman dimuat
        };
    </script>
